function PremiumPageHeader({ eyebrow, title, description, actions, icon: Icon }) {
  return (
    <section className="relative overflow-hidden rounded-[24px] border border-[#173764] bg-[linear-gradient(120deg,#071a3d_0%,#0a2d68_62%,#123f91_100%)] px-5 py-5 text-white shadow-[0_16px_38px_rgba(7,26,61,0.16)] sm:px-6 sm:py-6">
      ...
      <div className="relative z-10 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex min-w-0 items-start gap-3">
          ...
          <div className="min-w-0">
            ...
            {description && <p className="mt-1 max-w-2xl text-xs leading-5 text-blue-100/80 sm:text-sm">{description}</p>}
          </div>
        </div>
