  ...
  return (
    <div className="bg-white rounded-[30px] p-8 shadow-sm">
      ...
      <div className="grid grid-cols-4 gap-6 mb-10">
        ...
        <div>
          <Label>Pass-on VAT</Label>
          <select
            name="passOnVat"
            value={String(formData.passOnVat === true || formData.passOnVat === "true" || formData.passOnVat === 1 || formData.passOnVat === "1")}
            onChange={handleChange}
            className="w-full border rounded-xl p-3"
          >
            <option value="false">No — deduct the 12% VAT share</option>
            <option value="true">Yes — return the 12% VAT share</option>
          </select>
          <p className="mt-1 text-xs text-slate-500">Enabled agents receive their proportional VAT deduction back in commission computations.</p>
        </div>
